      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-1 gap-8 mt-10">
          <div className="flex flex-col md:flex-row items-center">
            <img src="/team.png" alt="teamwork" className="w-full md:w-1/2 rounded" />
          ...
          <div className="flex flex-col md:flex-row items-center">
            ...
            <img src="/collaboration.png" alt="collaboration" className="w-full md:w-1/2 rounded order-last md:order-first" />
          </div>
          <div className="flex flex-col md:flex-row items-center">
            <img src="/programming.png" alt="tracking" className="w-full md:w-1/2 rounded" />
            <p className="mt-4 md:mt-0 md:ml-6">
          ...
          <div className="flex flex-col md:flex-row items-center">
            ...
            <img src="/tasks.png" alt="tasks" className="w-full bg-gray-900 md:w-1/2 order-last md:order-first rounded" />
          </div>
        </div>
      </div>
    </div>
